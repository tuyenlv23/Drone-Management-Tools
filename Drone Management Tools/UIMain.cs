...
namespace Drone_Management_Tools
{
    public partial class UIMain : Form
    {
        ...
        private void UIMain_Load(object sender, EventArgs e)
        {
            ...
            pnlDrone1Comm1.Controls.Add(new UI_Comm_Spare());
            pnlDrone1Comm1.Controls[0].Dock = DockStyle.Fill;
            pnlDrone1Comm2.Controls.Add(new UI_Comm_Spare());
            pnlDrone1Comm2.Controls[0].Dock = DockStyle.Fill;
            pnlDrone2Comm1.Controls.Add(new UI_Comm_Spare());
            pnlDrone2Comm1.Controls[0].Dock = DockStyle.Fill;
            pnlDrone2Comm2.Controls.Add(new UI_Comm_Spare());
            pnlDrone2Comm2.Controls[0].Dock = DockStyle.Fill;
        ...
        private void utilitiesTab_MemoryFormat_Click(object sender, EventArgs e)
        {
            var _dialogResult = MessageBox.Show("Do you want to format memory?", "Send Memory Format", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (_dialogResult == DialogResult.Yes)
                this._dsProcess.SendMemoryFormat();
        }
        #endregion
        ...
        private void ShowScanDeviceConfig(DeviceManager deviceManager)
        {
            if (deviceManager.DeviceScan != null)
            {
                if (deviceManager.DeviceScan.Devices.Count > 0 && deviceManager.DeviceScan.Devices[0] != null)
                {
                    ...
                    if (this.InvokeRequired)
                        this.Invoke(new Action(() => ShowDroneSide1Config(_devOnboard1)));
                    else
                        ShowDroneSide1Config(_devOnboard1);
                }
                else
                {
                    txtDev1Name.Text = "";
                ...
                if (deviceManager.DeviceScan.Devices.Count > 1 && deviceManager.DeviceScan.Devices[1] != null)
                {
                    ...
                    if (this.InvokeRequired)
                        this.Invoke(new Action(() => ShowDroneSide2Config(_devOnboard2)));
                    else
                        ShowDroneSide2Config(_devOnboard2);
                }
                else
                {
                    txtDev2Name.Text = "";
        ...
        private void ShowDroneSide1Config(DeviceConfig deviceConfig)
        {
            var _droneModel = this._dsProcess.ConfigManager.DroneConfig.DroneModel;
            if (_droneModel == null)
                return;

            pnlDrone1Comm1.Controls.Clear();
            pnlDrone1Comm2.Controls.Clear();

            switch (deviceConfig.DeviceCommType)
            {
                case DeviceCommTypes.TCP:
                    {
                        UI_Comm_TCP _frm = new UI_Comm_TCP(_droneModel.DroneTCP.DroneTCP1);
                        _frm.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone1Comm2.Controls.Add(_frm2);

                        break;
                    }
                case DeviceCommTypes.UART:
                    {
                        UI_Comm_UART _frm = new UI_Comm_UART(_droneModel.DroneUART.DroneUART1);
                        _frm.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.I2C:
                    {
                        UI_Comm_I2C _frm = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C1);
                        _frm.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.CAN:
                    {
                        UI_Comm_CAN _frm = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.TCP_UART:
                    {
                        UI_Comm_TCP _frm1 = new UI_Comm_TCP(_droneModel.DroneTCP.DroneTCP1);
                        _frm1.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_UART _frm2 = new UI_Comm_UART(_droneModel.DroneUART.DroneUART1);
                        _frm2.Behavior(false);
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.TCP_I2C:
                    {
                        ...
                        _frm1.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_I2C _frm2 = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C1);
                        _frm2.Behavior(false);
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.TCP_CAN:
                    {
                        ...
                        _frm1.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_CAN _frm2 = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm2.Behavior(false);
                        pnlDrone1Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.UART_CAN:
                    {
                        UI_Comm_UART _frm1 = new UI_Comm_UART(_droneModel.DroneUART.DroneUART1);
                        _frm1.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_CAN _frm2 = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm2.Behavior(false);
                ...
                case DeviceCommTypes.I2C_CAN:
                    {
                        UI_Comm_I2C _frm1 = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C1);
                        _frm1.Behavior(false);
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_CAN _frm2 = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm2.Behavior(false);
                ...
                default:
                    {
                        UI_Comm_Spare _frm1 = new UI_Comm_Spare();
                        pnlDrone1Comm1.Controls.Add(_frm1);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone1Comm2.Controls.Add(_frm2);
            ...
            pnlDrone1Comm1.Controls[0].Dock = DockStyle.Fill;
            //pnlDrone1Comm1.Controls[0].Enabled = false;
            pnlDrone1Comm2.Controls[0].Dock = DockStyle.Fill;
            //pnlDrone1Comm2.Controls[0].Enabled = false;           
        }

        private void ShowDroneSide2Config(DeviceConfig deviceConfig)
        {
            var _droneModel = this._dsProcess.ConfigManager.DroneConfig.DroneModel;
            if (_droneModel == null)
                return;

            pnlDrone2Comm1.Controls.Clear();
            pnlDrone2Comm2.Controls.Clear();
            ...
            switch (deviceConfig.DeviceCommType)
            {
                case DeviceCommTypes.TCP:
                    {
                        UI_Comm_TCP _frm = new UI_Comm_TCP(_droneModel.DroneTCP.DroneTCP1);
                        _frm.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone2Comm2.Controls.Add(_frm2);

                        break;
                    }
                case DeviceCommTypes.UART:
                    {
                        UI_Comm_UART _frm = new UI_Comm_UART(_droneModel.DroneUART.DroneUART2);
                        _frm.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone2Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.I2C:
                    {
                        UI_Comm_I2C _frm = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C2);
                        _frm.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm);
                        UI_Comm_Spare _frm2 = new UI_Comm_Spare();
                        pnlDrone2Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.TCP_UART:
                    {
                        UI_Comm_TCP _frm1 = new UI_Comm_TCP(_droneModel.DroneTCP.DroneTCP1);
                        _frm1.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm1);
                        UI_Comm_UART _frm2 = new UI_Comm_UART(_droneModel.DroneUART.DroneUART2);
                        _frm2.Behavior(false);
                        pnlDrone2Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.TCP_I2C:
                    {
                        ...
                        _frm1.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm1);
                        UI_Comm_I2C _frm2 = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C2);
                        _frm2.Behavior(false);
                        pnlDrone2Comm2.Controls.Add(_frm2);
                ...
                case DeviceCommTypes.UART_CAN:
                    {
                        UI_Comm_UART _frm1 = new UI_Comm_UART(_droneModel.DroneUART.DroneUART2);
                        _frm1.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm1);
                        UI_Comm_CAN _frm2 = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm2.Behavior(false);
                ...
                case DeviceCommTypes.I2C_CAN:
                    {
                        UI_Comm_I2C _frm1 = new UI_Comm_I2C(_droneModel.DroneI2C.DroneI2C2);
                        _frm1.Behavior(false);
                        pnlDrone2Comm1.Controls.Add(_frm1);
                        UI_Comm_CAN _frm2 = new UI_Comm_CAN(_droneModel.DroneCAN.DroneCAN1);
                        _frm2.Behavior(false);
            ...
            pnlDrone2Comm1.Controls[0].Dock = DockStyle.Fill;
            //pnlDrone2Comm1.Controls[0].Enabled = false;
            pnlDrone2Comm2.Controls[0].Dock = DockStyle.Fill;
            //pnlDrone2Comm2.Controls[0].Enabled = false;
        }
